...
export function loadConfig() {
  const baseConfig = {
    ...
    featureFlags: {
      ...
      enableCoinGlassLiquidations: toBoolean(process.env.FEATURE_COINGLASS_LIQUIDATIONS, false),
    ...
    dataTtl: {
      ...
      liquidationPollMs: toNumber(process.env.TTL_LIQUIDATION_POLL_MS, 90_000),
    ...
    whaleFallback: {
      minUsd: toNumber(process.env.WHALE_FALLBACK_MIN_USD, 10_000_000),
      minIntervalMs: toNumber(process.env.WHALE_FALLBACK_MIN_INTERVAL_MS, 8000),
